...
github-repo: gracelawley/stat545-rstudio
...
# load other packages in DESCRIPTION that aren't already loaded
other_pkgs <- c("dichromat", "gapminder", "gender", "geonames", "git2r", 
                "gridExtra", "RColorBrewer", "rebird", "rplos", "tidyverse",
                "viridis", "genderdata", "gt")
purrr::walk(other_pkgs, require, character.only = TRUE)
```
