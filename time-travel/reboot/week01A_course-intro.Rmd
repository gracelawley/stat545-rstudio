...
<!--Original file: cm001_course-intro-sw-install-account-signup.md-->

# Week 1A Overview

* Introduction to the course
* To do before Week 1B (more below)
  - Install software
  - Sign up for accounts
* Don't panic if there are glitches. That's normal. 
* What's coming? We'll help you begin to use all your new toys in Week 1B!

<!--
TODO: insert resources if learner needs help / find substitutes for office hours and the ubc stat545 discussion repo (https://github.com/STAT545-UBC/Discussion/issues)

Come to [office hours](https://github.com/STAT545-UBC/Discussion/issues/312) and start using our [Discussion repo](https://github.com/STAT545-UBC/Discussion/issues) to [ask for help](http://stat545-ubc.github.io/help-STAT545.html).
-->
...
* [The Big Data Brain Drain: Why Science is in Trouble][big-data-brain-drain]
* [The data science Venn diagram][data-science-venn-diagram]
* 2014-08-17 NYT article [For Big-Data Scientists:, 'Janitor Work' Is Key Hurdle to Insights][nyt-janitor-work] by Steve Lohr
* [Data carpentry][data-carpentry-mimno] (response to NYT article re: janitor work)
* [The Forgotten Job of a Data Scientist: Editing][forgotten-job-editing]
* [10 things statistics taught us about big data analysis][ten-things-big-data]
* [The 80/20 rule of statistical methods development][eighty-twenty-rule]
* [Don't use Hadoop - your data isn't that big][hadoop-hatred]
* [Most data isn’t "big," and businesses are wasting money pretending it is][most-data-isnt-big]
* [Big data is like teenage sex][ariely-fb-post]
* [Edward Tufte][tufte-web] book [chapter 5 on the Challenger Disaster][tufte-challenger]
...
[big-data-brain-drain]: https://jakevdp.github.io/blog/2013/10/26/big-data-brain-drain/
[data-science-venn-diagram]: http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram
[nyt-janitor-work]: https://www.nytimes.com/2014/08/18/technology/for-big-data-scientists-hurdle-to-insights-is-janitor-work.html?partner=rss&emc=rss&smid=tw-nytimesscience&_r=0
[data-carpentry-mimno]: http://www.mimno.org/articles/carpentry/
[forgotten-job-editing]: https://web.archive.org/web/20150516191614/http://www.john-foreman.com/blog/the-forgotten-job-of-a-data-scientist-editing
[ten-things-big-data]: https://simplystatistics.org/2014/05/22/10-things-statistics-taught-us-about-big-data-analysis/
[eighty-twenty-rule]: https://simplystatistics.org/2014/03/20/the-8020-rule-of-statistical-methods-development/
[hadoop-hatred]: https://www.chrisstucchio.com/blog/2013/hadoop_hatred.html
[most-data-isnt-big]: https://qz.com/81661/most-data-isnt-big-and-businesses-are-wasting-money-pretending-it-is/
[ariely-fb-post]: https://www.facebook.com/dan.ariely/posts/904383595868
[tufte-web]: https://www.edwardtufte.com/tufte/
[tufte-challenger]: https://www.edwardtufte.com/tufte/books_textb
